<!DOCTYPE html>
<html dir="ltr" class=" flnot idc0_326" lang="en">

<head>
    <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
    <meta name="robots" content="noindex,nofollow,noarchive,nosnippet,noodp,notranslate,noimageindex">
    <title>Welcome to the demonstration ACME Bundle of Symfony!</title>
    <style>
            body {
                background: hsla(<?php echo $hue; ?>, 20%, 95%, 1);
                color: hsla(<?php echo $hue; ?>, 20%, 45%, 1);
                display: flex;
            ...
            a {
                color: hsla(<?php echo $hue; ?>, 20%, 45%, 0.75);
            }
            ...
            code {
                border-radius: 25px;
                background: hsla(<?php echo $hue; ?>, 20%, 95%, 1);
                box-shadow: 0 0 45px -15px hsl(114, 20%, 2%);
                color: hsla(<?php echo $hue; ?>, 20%, 45%, 1);
            ...
            .check {
                color:#FFF;
                background: hsla(<?php echo $hue; ?>, 20%, 45%, 1);
                border-radius: 20px;
                width: 80px;
                display: flex;
                align-items: center;
            ...
            .check svg {
                fill: hsla(<?php echo $hue; ?>, 20%, 95%, 1);
            }
            ...
            .resource svg {
                height: 48px;
                width: 48px;
                fill: hsla(<?php echo $hue; ?>, 20%, 45%, 1);
                margin-bottom: 5px;
            }
...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="status">
                <code>
                    <span class="check" style="width:100px;">Public</span>
            ...
            <div class="footer">
                <canvas id="waves" width="1280" height="60"></canvas>
            </div>
        </div>
    ...
    window.addEventListener('resize', function() { breakpoint = getBreakpoint(); }, false);
    ...
    (function(){
        ...
        var canvas,context;
        var waves = [];
        var colours = ["hsla(<?php echo $hue; ?>, 20%, 95%, 0.3)","hsla(<?php echo $hue; ?>, 20%, 95%, 0.6)","hsla(<?php echo $hue; ?>, 20%, 95%, 1)"]
        var dt = 24;
        ...
        function init() {
            ...
            for (var i = 0; i < nwaves; i++)
                var temp = new Wave(colours[i],lambda,nodes);
        }
